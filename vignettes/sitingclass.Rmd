...
remotes::install_git(paste0("https://", Sys.getenv("GIT_ID"), ":",
...
```{r,fig.dim = c(10, 8), out.width="80%", fig.cap="Grid and buffer with 'Norge i bilder' imagery."}
...
# Load Karverket's DEMs -f_ow = TRUE to overwrite files
f_ow  <- FALSE 
