testthat::test_that("compute horizon works", {
  ...
  horizon_expected <- data.frame(azimuth = c(0, 350, 340, 330, 320, 310, 300,
                                 ...
                                 horizon_height = c(9.9, 2.3, 3.2, 20.9, 12.2,
                                                    32.8, 6.6, 9.1, 10.8, 9.8,
                                                    8.0, 6.6, 12.6, 14.4, 11.8,
                                                    22.7, 63.3, 63.3, 63.3,
                                                    63.3, 63.3, 63.3, 7.3, 7.9,
                                                    12.5, 9.7, 10.6, 9.1, 7.8,
                                                    21.4, 22.8, 18.3, 18.6,
                                                    18.4, 17.7, 9.9))
  ...
  # Keep azimuth and height / Remove distance
